...
<head>
<meta charset="utf-8">
<title>PATA JOB / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs">Come back frequently for latest job updates</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php"><big><strong>PataJob</strong></big> <small><sub>you want it, you get it here</sub></small></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="<?php echo !isset($_GET['q'])? 'active' :''?>"><a href="<?php echo web_root; ?>index.php">Homepage</a></li> 
                        <li class="dropdown">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Filter Search <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo web_root; ?>index.php?q=search-company"> By Company</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-function"> By Function</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-jobtitle"> By Title</a></li>
                        
                          </ul>
                       </li> 
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">most searched <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                            <?php 
                            $sql = "SELECT * FROM `tblcategory` LIMIT 5";
                            $mydb->setQuery($sql);
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=hiring">Top Hiring</a></li>
  ...
  <div class="container">
    ...
    <div class="col-md-6 col-sm-6">
        <div class="widget">
         ...
         Near Zetech Uni, Ruiru Branch<br>
           2678 - 00200 , Kiambu County, Kenya</address>
          <p>
          <i class="fa fa-phone"></i> (254) 712345678 <br>
            <i class="icon-envelope-alt"></i> patajob@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-6 col-sm-6">
        <div class="widget">
          <h5 class="widgetheading">Quick Navigation</h5>
          <ul class="link-list">
            <li><a href="<?php echo web_root; ?>index.php">Homepage</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span> John and Ezra&copy; 2022.  All right reserved.  
            </p>
          </div>
        </div>
        <div  class="col-lg-6">
          <ul class="social-network">
          <li><a href="https://www.github.com/" data-placement="top" title="github"><i class="fa fa-github"></i></a></li>  
